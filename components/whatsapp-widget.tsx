...
export function WhatsAppWidget() {
  ...
  const phoneNumber = "+254757883799" // Econuru WhatsApp number with + for display
  const waPhoneNumber = "254757883799" // wa.me format (no +)
            ...
            {isOpen && (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm">Econuru laundry</h4>
                    <p className="text-xs text-text-light">Typically replies within minutes</p>
                  </div>
                </div>
                <p className="text-sm mb-4">Hello! How can we help you with your laundry needs today?</p>
                <a
