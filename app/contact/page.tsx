  ...
  const contactInfo = [
    {
      iconName: "Phone",
      title: "Phone",
      details: ["+254 757 883 799"],
      description: "Call us for immediate assistance"
    },
    {
      iconName: "Mail",
      title: "Email",
      details: ["econuruservices@gmail.com"],
  ...
  const faqs = [
    {
      ...
      answer: "You can schedule a pickup through our website, mobile app, or by calling us directly. We offer flexible time slots to fit your schedule."
    },
    {
      question: "What areas do you serve?",
      answer: "We currently serve Nairobi and its surrounding areas including Westlands, Kilimani, Lavington, and Karen."
    },
    {
      question: "How long does the service take?",
      answer: "Standard service takes 24-48 hours, while express service is available for same-day or next-day delivery."
    },
    {
      question: "Do you offer dry cleaning?",
      answer: "Yes, we offer professional dry cleaning services for delicate fabrics and formal wear."
    }
  ]
      ...
      >
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              className="text-center bg-primary/10 rounded-2xl px-4 py-6 md:py-8 md:px-8 mb-4"
              initial={{ opacity: 0, y: 20 }}
              animate={heroInView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-3 text-primary">Get in Touch</h1>
              <p className="text-lg text-text-light max-w-2xl mx-auto">
                Have questions about Ecolaundryservices? Need to schedule a pickup? We're here to help you with all your laundry needs.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            >
              <div>
                ...
                <p className="text-text-light mb-8">
                  We're here to help with all your laundry needs. Reach out to us through any of the channels below.
                </p>
              </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p className="text-text-light max-w-2xl mx-auto">
              Visit our facility in Westlands, Nairobi for a tour or to drop off your items in person.
            </p>
          </motion.div>
          ...
          >
            <div className="relative h-[400px] w-full">
              <iframe
                ...
                title="Ecolaundryservices Location"
                className="rounded-2xl"
              ></iframe>
              <div className="absolute bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg">
                <h3 className="font-semibold">Ecolaundryservices</h3>
                <p className="text-sm text-text-light">Westlands, Nairobi, Kenya</p>
                <a 
                  href="https://maps.app.goo.gl/kGQNqFeAnnvJTGs56" 
                  target="_blank" 
