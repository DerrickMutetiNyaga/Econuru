...
const BUTTON_LINK_OPTIONS = [
  ...
  { value: '/services/laundry', label: 'Laundry Services' },
  { value: '/services/office-cleaning', label: 'Office Cleaning' },
  { value: '/services/home-cleaning', label: 'Home Cleaning' },
...
export default function BannersPage() {
  ...
  const handleEditBanner = (banner: Banner) => {
    ...
    setEditForm({
      ...
      button1: banner.button1 || { text: '', link: '' },
      button2: banner.button2 || { text: '', link: '' },
