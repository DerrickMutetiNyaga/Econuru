...
export default function ServicesPage() {
  ...
  const handleInputChange = (field: string, value: string | boolean) => {
    ...
    if (field === 'featured' && value === true) {
      const currentFeaturedCount = services.filter(service => service.featured).length
  ...
  // Function to map category name to enum value
          ...
          <div className="bg-accent/5 border border-accent/20 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-accent flex items-center gap-2">
                ...
                Featured Services ({services.filter(service => service.featured).length}/4)
              </h3>
                ...
                <div className="flex-1 overflow-y-auto space-y-4 py-4 px-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-text-light">
                      {services.filter(service => service.featured).length}/4 featured
                    </div>
                  </div>
                </div>
              ...
              >
                <Card className="luxury-card overflow-hidden h-full">
                  ...
                  <CardContent className="p-4 sm:p-6">
                    ...
                    <p className="text-text-light text-sm mb-3 sm:mb-4 line-clamp-2">{service.description}</p>
