      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-mint-green hover:bg-mint-green/90 text-white rounded-xl w-full sm:w-auto">
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center text-text-light">
              ...
              <Button className="bg-mint-green hover:bg-mint-green/90 text-white rounded-xl" onClick={() => setIsDialogOpen(true)}>
                  ...
                  <div key={exp._id} className="rounded-2xl border bg-white p-4 flex flex-col gap-2 shadow luxury-shadow">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-mint-green-light">
                          <DollarSign className="w-5 h-5 text-mint-green" />
                        </span>
                        <span className="font-inter font-semibold text-base text-gray-900 capitalize truncate max-w-[9rem]">{exp.title}</span>
                      </div>
                      <div className="text-right">
                        <span className="block text-lg font-bold text-mint-green font-inter">Ksh {exp.amount.toLocaleString()}</span>
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <span className="flex items-center gap-1 bg-mint-green-light text-mint-green px-3 py-0.5 rounded-full text-xs font-medium font-inter">
