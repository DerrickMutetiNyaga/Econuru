...
export function getAccessiblePages(user: IUser | null): string[] {
  ...
  if (user.role === 'superadmin') {
    return [
      ...
      'reports', 'payments', 'pending-payments', 'users', 'expenses', 'gallery', 'testimonials', 'promotions', 'settings'
    ];
  }
...
export const ADMIN_PAGES = {
  ...
  'pending-payments': { label: 'M-Pesa Transactions', icon: 'Clock', path: '/admin/payments/pending' },
