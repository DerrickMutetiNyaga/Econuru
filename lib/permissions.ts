...
export function getAccessiblePages(user: IUser | null): string[] {
  ...
  if (user.role === 'superadmin') {
    return [
      ...
      'reports', 'payments', 'pending-payments', 'mpesa-transactions', 'users', 'expenses', 'gallery', 'testimonials', 'promotions', 'settings'
    ];
  }
...
export const ADMIN_PAGES = {
  ...
  'pending-payments': { label: 'Pending Confirmations', icon: 'Clock', path: '/admin/payments/pending' },
